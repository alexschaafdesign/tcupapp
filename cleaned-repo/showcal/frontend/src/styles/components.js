...
export const components = {
    ...
    MuiSelect: {
      ...
      MuiInputLabel: {
        styleOverrides: {
          root: {
            backgroundColor: '#fff', // Set the white background
            padding: '0 4px', // Optional: Add padding for better spacing
            borderRadius: '4px', // Optional: Add rounded corners
            transform: 'translate(14px, -6px) scale(0.75)', // Adjust the position and scaling of the label
            '&.Mui-focused': {
              backgroundColor: '#fff', // Ensure the background stays white when focused
            },
          },
        },
      },
